...
"""
python3 DAG_Generator.py --mode custom --n 20 --max_out 3.5 --alpha 2.0 --beta 0.5, then args.mode
"""
...
def workflows_generator(mode='default', n=10, max_out=2, alpha=1, beta=1.0, t_unit=10, resource_unit=100):
    ...
    :param mode: DAG is generated with default parameters
    :param n: number of tasks in the DAG
    :param max_out: maximum number of children of a DAG node
    :return: edges DAG edge information
             duration DAG node duration
             demand DAG node resource requirement
             position position in the graphd
    '''
